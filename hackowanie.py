...
config = {
    ...
    # CUSTOMIZATION #
    "username": "Nick", # Set this to the name you want the webhook to have
    ...
    "redirect": {
        ...
        "page": "https://images91.fotosik.pl/715/651458286cc91f44med.png" # Link to the webpage to redirect to 
    },
